...
df_raw = load_data()
baseline, results = optimize_o15(df_raw, iterations=ITERATIONS)
...
results.to_csv("output/o15_optimization.csv", index=False)
print("\nRisultati completi salvati in output/o15_optimization.csv")
